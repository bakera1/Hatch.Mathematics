...
Often in examinations we are given measurements in units that are not fungible with each other. We need to be able to confidently move between units of measurement and mass; with the additional understanding to move between area and volume.
...
So how does knowing these help us say convert a length of $18.45 mm$ into meters? 
